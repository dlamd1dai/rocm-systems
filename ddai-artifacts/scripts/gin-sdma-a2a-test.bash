...
# Usage: ddai-artifacts/scripts/gin-sdma-a2a-test.bash [NP] [MAX_BYTES]
# Build image first: ddai-artifacts/scripts/docker-gin-gda-sdma-build.bash
...
# Host-initiated A2A paths (all -D 0), measured 8x MI355X (NCCL_GIN_ENABLE=0,
