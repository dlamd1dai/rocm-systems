...
#include "nccl_device/gin/anvil_sdma/gin_fabric_ll_device_prims.h"
...
// kDdaLLMaxBytes / LLPacket16 / ddaLL{Store,Load}LineB128 / epoch helpers
// live in gin_fabric_ll_device_prims.h (included above) so GIN device-API
// AllToAll can share them without pulling this algorithms/dda header.
