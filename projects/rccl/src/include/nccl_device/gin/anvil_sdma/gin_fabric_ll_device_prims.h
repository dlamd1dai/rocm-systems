...
// Non-atomic epoch bump. GIN fabric-LL A2A must pass a GIN-private buffer
// (gpuCtx->fabricA2ALlEpoch), not comm->ddaLLEpochDev used by host DDA.
...
// Publishes the flag this block just computed. Correctness rests on the
...
// a device busy-lock serializes launches (ginFabricLlBusyAcquire on
